...
const Contact = () => {
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
      <div className="flex items-center lg:mb-0 mb-10">
        <div className="">
          ...
          <form action="">
            <input
              type="text"
              className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border-2 border-gray-500 focus:outline-none py-2 px-4 mb-8"
              placeholder="Name"
            />
            <input
              type="email"
            ...
            <textarea
              name=""
              id="text"
              className="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border-2 border-gray-500 focus:outline-none px-4 py-4 mb-8"
              placeholder="Phone"
              defaultValue={""}
            />
      ...
      <div className="lg:max-w-xl w-full h-[490px] rounded-xl flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://thumbs.dreamstime.com/z/bread-pastry-food-seamless-pattern-background-bakery-wheat-rye-loaf-croissant-baguette-cake-cookie-cupcake-bun-toast-bagel-116682108.jpg')] ">
        <div className="">
