        ...
        <>
            <section className="py-10 bg-white">
                <div className="2xl:container mx-auto">
                    <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
                        ...
                        <div className="space-y-5">
                            <p className="text-3xl font-semibold">Hours & Location</p>
                            <p className="font-medium">789 Oak Lane,<br />
                                Lakeside, TX 54321<br />
                                470-601-1911</p>
                            <p className="font-medium">Monday - Sunday <br />
                                7:00am - 8:00pm </p>
                        </div>
                    </div>
                </div>
